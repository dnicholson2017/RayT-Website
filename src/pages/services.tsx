...
const Services = () => {
    ...
    const [activeService, setActiveService] = useState<null | string>(null);
    ...
    return (
        <div>
            ...
            <div className="row gy-4">
                ...
                {/* Add remaining service items here */}
            ...
            {activeService && (
                <div className="dialog-overlay">
                    <div className="dialog-box">
                        ...
                        {/* <h3>{serviceData.find((service) => service.id === activeService)?.title}</h3>
                        <p>{serviceData.find((service) => service.id === activeService)?.details}</p> */}
                    </div>
                </div>
            )}
